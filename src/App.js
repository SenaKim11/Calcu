...
export default function App() {
  ...
  const nameClickHandler = (e) => {
    e.preventDefault();
    let name = "Kim Julianne B. Sena";
    setDisp(name);
  }

  return (
    <div className="App">
      <div className="CalcContainer"><h1>Kim Julianne B. Sena - IT3A</h1>
        ...
        <div className="Name">
          <CalcButton label={"SENA"} onClick={nameClickHandler} buttonClassName={"CalcButtonName"}/>
        </div>
      </div>
    </div>
  );
